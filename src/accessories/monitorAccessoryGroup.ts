import type { API, Characteristic, Logger, PlatformAccessory, Service, WithUUID } from 'homebridge';
...
export class MonitorAccessoryGroup {
  ...
  private updateHumidity(reading: QingpingReading): void {
  ...
  private getPrimaryService(key: string, name: string, ServiceClass: ServiceConstructor): Service {
  ...
  private setupInformationService(accessory: PlatformAccessory, name: string): void {
